"""Shah Alam (2016-2024) - 5 districts"""
...
DISTRICTS = [
    ...
    {'name': 'Section 2', 'lat': 3.0833, 'lon': 101.5333},
    {'name': 'Section 14', 'lat': 3.0833, 'lon': 101.5500},
    {'name': 'Section 18', 'lat': 3.0500, 'lon': 101.5333},
    {'name': 'Bukit Jelutong', 'lat': 3.1000, 'lon': 101.5167},
    {'name': 'Setia Alam', 'lat': 3.1000, 'lon': 101.4500},
]
...
if __name__ == "__main__":
    ...
    for dist in DISTRICTS:
        ...
        for i, dt in enumerate(dates):
            ...
            if r:
                data.append({'city': 'Shah Alam', 'district': dist['name'], 'latitude': dist['lat'], 'longitude': dist['lon'], 'date': dt.strftime('%Y-%m-%d'), 'temperature': r['temperature'], 'ndvi': r['ndvi'], 'ndbi': r['ndbi'], 'year': dt.year, 'month': dt.month})
                s += 1
    ...
    if data:
        ...
        pd.DataFrame(data).to_parquet('data/shah_alam_2016_2024.parquet', index=False)
